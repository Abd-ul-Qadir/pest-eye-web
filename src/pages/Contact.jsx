                        ...
                        <div className="col-md-12">
                            <div className="tf-infor-wrap">
                                <div className="tf-infor">
                                    <div className="icon">
                                        <img src={icon1} alt="Pest Eye" />
                                    </div>
                                    <h3 className="title">Location</h3>
                                    <p className="sub-title">Islamabad, Pakistan</p>
                                </div>
                                <div className="tf-infor">
                                    <div className="icon">
                                        <img src={icon2} alt="Pest Eye" />
                                    </div>
                                    <h3 className="title">Email</h3>
                                    <p className="sub-title">abdulqadir12511@gmail.com</p>
                                </div>
                                <div className="tf-infor">
                                    <div className="icon">
                                        <img src={icon3} alt="Pest Eye" />
                                    </div>
                                    <h3 className="title">Phone</h3>
                                    <p className="sub-title">+92 324 5424298</p>
                                </div>
                            </div>
                        </div>
                    </div>
